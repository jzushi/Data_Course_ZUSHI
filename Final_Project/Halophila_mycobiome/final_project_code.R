...
path <- "~/Desktop/Data_Course_ZUSHI/Final_Project/Halophila_mycobiome/fwd"
list.files(path)
...
saveRDS(seqtab.nochim, file = "halo_raw_data.rds", ascii = FALSE, version = NULL,
        compress = TRUE, refhook = NULL)

taxa <- assignTaxonomy(seqtab.nochim, "../Halophila_mycobiome/UNITE_anthozoa_enhalus_halophila.fasta.gz", multithread = TRUE)
 #phyloseek tutorials
