...
str_replace(long$Gender, "Male", "-Male")
...
names(long)[names(long) == "Group"]
names(long)[names(long) == "Group"] <- "AgeRange"

write.csv(long,"./../Data_Course_ZUSHI/Class_Practice/ugly_data1_cleaned.csv", row.names = FALSE, quote = FALSE)
read.csv("./../../Desktop/Data_Course_ZUSHI/Class_Practice/ugly_data1_cleaned.csv")
